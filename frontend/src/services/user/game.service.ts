...
export class GameService {
	 ...
	 */
	public async invitePlayer(type: "local" | "matchmaking_request" | "tournament" | "invite" | "invite-accept" | "clean_request" | "tournament_clean_request", invitedId: number, tournamentID?: number): Promise<void> {
